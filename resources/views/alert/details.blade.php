...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <p> <a href="{{ route('alert.index') }}" class="btn btn-secondary">Back to Alert</a> <br/></p>
                <h3>Alert: <button type="button" class="btn   btn-info">{{ $alert->alert_message }}</button></h3>
                <h3>Add Rule</h3>
                <form action="{{ route('rule.create', $alert) }}" method="post">
                    @csrf
